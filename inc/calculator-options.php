...
function gts_register_calculator_fields()
{
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_calc_fixed_city_tariffs',
				'label' => 'Fixed City Tariffs (Priority over KM Formula)',
				'name' => 'calc_fixed_city_tariffs',
				'type' => 'repeater',
				'layout' => 'table',
				'button_label' => 'Add Fixed Tariff',
				'instructions' => 'Used first for city routes (airport-city/city-city). If no match found, KM formula is used.',
				'sub_fields' => array(
					array(
						'key' => 'field_calc_fixed_country',
						'label' => 'Country',
						'name' => 'country',
						'type' => 'text',
						'wrapper' => array('width' => '12'),
					...
					array(
						'key' => 'field_calc_fixed_route_type',
						'label' => 'Route Type',
						'name' => 'route_type',
						'type' => 'select',
						'choices' => array(
							'airport_city' => 'Airport ↔ City',
							'city_city' => 'City ↔ City (same city)',
						),
						'default_value' => 'airport_city',
						'wrapper' => array('width' => '10'),
					),
					array(
						'key' => 'field_calc_fixed_airport_keywords',
						'label' => 'Airport keywords (optional)',
						'name' => 'airport_keywords',
						'type' => 'text',
						'instructions' => 'Comma separated, e.g. MUC, Munich airport',
						'wrapper' => array('width' => '14'),
					),
					array(
						'key' => 'field_calc_fixed_standard_price',
						'label' => 'Standard',
						'name' => 'price_standard',
						'type' => 'number',
						'step' => '0.01',
					...
					array(
						'key' => 'field_calc_fixed_night_override',
						'label' => 'Night surcharge override (%)',
						'name' => 'night_surcharge_percent',
						'type' => 'number',
						'append' => '%',
						'instructions' => 'Optional. If set, overrides regional/default night surcharge for this tariff.',
						'wrapper' => array('width' => '10'),
					),
					array(
						'key' => 'field_calc_fixed_notes',
						'label' => 'Notes',
						'name' => 'notes',
						'type' => 'text',
						'wrapper' => array('width' => '6'),
					),
					array(
						'key' => 'field_calc_fixed_enabled',
						'label' => 'Active',
						'name' => 'enabled',
						'type' => 'true_false',
						'default_value' => 1,
						'ui' => 1,
						'wrapper' => array('width' => '4'),
					),
				),
			),
			array(
				'key' => 'field_calc_fixed_class_column_map',
				'label' => 'Vehicle Class → Fixed Tariff Column Map',
				'name' => 'calc_fixed_class_column_map',
				'type' => 'repeater',
				'layout' => 'table',
				'button_label' => 'Add Mapping',
				'sub_fields' => array(
					array(
						'key' => 'field_calc_fixed_map_class',
						'label' => 'Vehicle class key',
						'name' => 'class_key',
						'type' => 'select',
						'choices' => array(
							'business' => 'Business',
					...
					array(
						'key' => 'field_calc_fixed_map_column',
						'label' => 'Fixed price column',
						'name' => 'price_column',
						'type' => 'select',
						'choices' => array(
							'standard' => 'Standard',
					...
					array(
						'key' => 'field_calc_fixed_map_enabled',
						'label' => 'Active',
						'name' => 'enabled',
						'type' => 'true_false',
						'default_value' => 1,
			...
			array(
				'key' => 'field_calc_night_rules_by_region',
				'label' => 'Night Rules by Region',
				'name' => 'calc_night_rules_by_region',
				'type' => 'repeater',
				'layout' => 'table',
				'button_label' => 'Add Night Rule',
				'sub_fields' => array(
					array(
						'key' => 'field_calc_night_rule_region',
						'label' => 'Region',
						'name' => 'region_key',
						'type' => 'text',
					...
					array(
						'key' => 'field_calc_night_rule_from',
						'label' => 'From (HH:MM)',
						'name' => 'night_from',
						'type' => 'text',
						'default_value' => '22:00',
					...
					array(
						'key' => 'field_calc_night_rule_percent',
						'label' => 'Charge (%)',
						'name' => 'charge_percent',
						'type' => 'number',
						'step' => '0.01',
					...
					array(
						'key' => 'field_calc_night_rule_enabled',
						'label' => 'Active',
						'name' => 'enabled',
						'type' => 'true_false',
						'default_value' => 1,
			...
			array(
				'key' => 'field_calc_country_region_map',
				'label' => 'Country → Region Mapping',
				'name' => 'calc_country_region_map',
				'type' => 'repeater',
				'layout' => 'table',
				'button_label' => 'Add Country Mapping',
				'sub_fields' => array(
					array(
						'key' => 'field_calc_country_region_country',
						'label' => 'Country',
						'name' => 'country',
						'type' => 'text',
						'wrapper' => array('width' => '45'),
					...
					array(
						'key' => 'field_calc_country_region_region',
						'label' => 'Region',
						'name' => 'region_key',
						'type' => 'text',
						'wrapper' => array('width' => '45'),
					...
					array(
						'key' => 'field_calc_country_region_enabled',
						'label' => 'Active',
						'name' => 'enabled',
						'type' => 'true_false',
						'default_value' => 1,
...
function gts_populate_test_calculator_data()
{
	...
	$fixed_class_map = array(
		array( 'class_key' => 'business', 'price_column' => 'e_class', 'enabled' => 1 ),
		array( 'class_key' => 'premium', 'price_column' => 's_class', 'enabled' => 1 ),
		array( 'class_key' => 'vip', 'price_column' => 's_class', 'enabled' => 1 ),
		array( 'class_key' => 'minivan', 'price_column' => 'v_class', 'enabled' => 1 ),
		array( 'class_key' => 'limousine', 'price_column' => 's_class', 'enabled' => 1 ),
		array( 'class_key' => 'special_request', 'price_column' => 'standard', 'enabled' => 1 ),
	);
	update_field('calc_fixed_class_column_map', $fixed_class_map, 'option');

	$night_rules = array(
		array( 'region_key' => 'Europe', 'night_from' => '22:00', 'night_to' => '06:00', 'charge_percent' => 25, 'enabled' => 1 ),
		array( 'region_key' => 'The North America', 'night_from' => '22:00', 'night_to' => '06:00', 'charge_percent' => 20, 'enabled' => 1 ),
		array( 'region_key' => 'The Central America', 'night_from' => '21:00', 'night_to' => '06:00', 'charge_percent' => 30, 'enabled' => 1 ),
		array( 'region_key' => 'The South America', 'night_from' => '21:00', 'night_to' => '06:00', 'charge_percent' => 30, 'enabled' => 1 ),
		array( 'region_key' => 'Middle East', 'night_from' => '22:00', 'night_to' => '06:00', 'charge_percent' => 0, 'enabled' => 1 ),
		array( 'region_key' => 'Central Asia and the Far East', 'night_from' => '22:00', 'night_to' => '06:00', 'charge_percent' => 30, 'enabled' => 1 ),
		array( 'region_key' => 'Australia', 'night_from' => '22:00', 'night_to' => '06:00', 'charge_percent' => 25, 'enabled' => 1 ),
		array( 'region_key' => 'Afrika', 'night_from' => '21:00', 'night_to' => '06:00', 'charge_percent' => 30, 'enabled' => 1 ),
	);
	update_field('calc_night_rules_by_region', $night_rules, 'option');

	$country_region_map = array(
		array( 'country' => 'Germany', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Switzerland', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Austria', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'France', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Italy', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Spain', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'United Kingdom', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Netherlands', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Belgium', 'region_key' => 'Europe', 'enabled' => 1 ),
		array( 'country' => 'Poland', 'region_key' => 'Europe', 'enabled' => 1 ),
	);
	update_field('calc_country_region_map', $country_region_map, 'option');
