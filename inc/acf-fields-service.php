	...
	$layouts = array(
		...
		'layout_fleet'        => array(
			...
			'sub_fields' => array(
				...
				array(
					'key'           => 'field_service_fleet_vehicle_categories',
					'label'         => 'Select Transport Categories',
					...
					'min'           => 0,
					'max'           => 20,
					'instructions'  => 'Select which transport categories to display. Leave empty to show all.',
				),
			),
		),
		...
		'layout_bottom_text'  => array(
			...
			'sub_fields' => array(
				...
				array(
					'key'          => 'field_service_bottom_text_enable_toggle',
				...
				array(
					'key'           => 'field_service_bottom_text_preview_description',
					'label'         => 'Preview Description (Collapsed)',
					'name'          => 'preview_description',
					'type'          => 'textarea',
					'rows'          => 3,
					'instructions'  => 'Optional. If empty, preview will be generated automatically from full description.',
				),
				array(
				...
				array(
					'key'           => 'field_service_bottom_text_collapse_text',
					'label'         => 'Show Less Text',
					'name'          => 'collapse_text',
					'type'          => 'text',
					'default_value' => 'Show less',
				),
				array(
