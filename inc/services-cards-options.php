...
function gts_get_default_services_cards() {
	return array(
		array(
			...
			'url'         => gts_localized_home_url( '/services/special-transfers/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/city-to-city/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/airport-transfer/' ),
		),
		array(
			'title'       => 'Hourly Hire',
			...
			'url'         => gts_localized_home_url( '/services/hourly-hire/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/professional-chauffeur-service/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/limousine-service/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/wedding/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/cultural-sport-events/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/family-travel-chauffeur-service/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/medical-transportation/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/travel-personal-interpreter/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/travel-planninig/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/shoping/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/corporate-events-chauffeur-service/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/private-tours/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/travel-agencies/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/mobility-partnership/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/airport-transfer-service/' ),
		),
		array(
			...
			'url'         => gts_localized_home_url( '/services/corporations/' ),
		),
	);
}
