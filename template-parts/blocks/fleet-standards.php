...
<section class="fleet-standards">
		<div class="fleet-standards__container">
			<div class="fleet-standards__top">
				<div class="fleet-standards__title"><?php echo wp_kses_post( 'Standards Across All<br>Fleet Categories' ); ?></div>
		...
		<div class="fleet-standards__grid">
				<article class="fleet-standards-card fleet-standards-card--dark">
					<div class="fleet-standards-card__icon-wrap">
						<img src="<?php echo esc_url( $base . 'fleet-icon-1.svg' ); ?>" alt="" aria-hidden="true" class="fleet-standards-card__icon" width="20" height="20" loading="lazy">
					</div>
				...
				<article class="fleet-standards-card fleet-standards-card--dark">
					<div class="fleet-standards-card__icon-wrap">
						<img src="<?php echo esc_url( $base . 'fleet-icon-2.svg' ); ?>" alt="" aria-hidden="true" class="fleet-standards-card__icon" width="20" height="20" loading="lazy">
					</div>
				...
				<article class="fleet-standards-card fleet-standards-card--light">
					<div class="fleet-standards-card__icon-wrap fleet-standards-card__icon-wrap--light">
						<img src="<?php echo esc_url( $base . 'fleet-icon-3.svg' ); ?>" alt="" aria-hidden="true" class="fleet-standards-card__icon" width="20" height="20" loading="lazy">
					</div>
				...
				<article class="fleet-standards-card fleet-standards-card--dark">
					<div class="fleet-standards-card__icon-wrap">
						<img src="<?php echo esc_url( $base . 'fleet-icon-4.svg' ); ?>" alt="" aria-hidden="true" class="fleet-standards-card__icon" width="20" height="20" loading="lazy">
					</div>
